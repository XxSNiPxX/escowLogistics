...
export { QueryProposalRequest, QueryProposalsRequest, QueryDepositsResponse, Deposit, VotingParams, MsgSubmitProposal, QueryVoteRequest, QueryParamsResponse, GenesisState, DepositParams, Vote, Proposal, QueryVotesResponse, QueryParamsRequest, QueryDepositResponse, QueryTallyResultRequest, QueryTallyResultResponse, MsgVote, TextProposal, MsgSubmitProposalResponse, QueryProposalResponse, QueryVoteResponse, QueryVotesRequest, MsgDepositResponse, TallyResult, QueryProposalsResponse, QueryDepositRequest, MsgVoteResponse, MsgVoteWeightedResponse, MsgDeposit, TallyParams, WeightedVoteOption, QueryDepositsRequest, MsgVoteWeighted };
